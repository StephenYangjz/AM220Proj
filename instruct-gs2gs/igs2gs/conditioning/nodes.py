...
class SaveImage:
    ...
    def save_images(self, path, images, filename_prefix="ComfyUI", prompt=None, extra_pnginfo=None):
...
def load_custom_nodes():
    ...
    node_paths = folder_paths.get_folder_paths(os.path.join("custom_nodes"))
    node_import_times = []
