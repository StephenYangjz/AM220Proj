...
class Blender(DataParser):
    ...
    def _generate_dataparser_outputs(self, split="train"):
        ...
        for frame in meta["frames"]:
            ...
            depth = self.data / Path(frame["depth"].replace("./", "") + ".jpg")
            masks = [self.data / Path(mask_path.replace("./", "") + ".jpg") for mask_path in frame["mask"]]
            image_filenames.append(fname)
            composite_masks.append(masks)
            depths.append(depth)
        ...
        metadata = {"composite_masks":composite_masks, "depths":depths}
